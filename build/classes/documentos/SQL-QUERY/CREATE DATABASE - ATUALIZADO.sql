...
CREATE TABLE Usuario (id_usuario integer IDENTITY(1,1) CONSTRAINT PK_id_usuario PRIMARY KEY,
						...
						cmtech INTEGER,
						notebook VARCHAR(5),
						data_alteracao VARCHAR(60),
						id_versao_office integer);
...
CREATE TABLE Versao_Office (id_versao_office integer IDENTITY(1,1)CONSTRAINT PK_id_versao_office PRIMARY KEY,
							descricao_office VARCHAR (50) not null);
...
ALTER TABLE Usuario ADD CONSTRAINT FK_versao_office FOREIGN KEY(id_versao_office)REFERENCES Versao_Office(id_versao_office);
ALTER TABLE Gerencia ADD CONSTRAINT FK_pavimento_gerencia FOREIGN KEY(id_pavimento)REFERENCES Pavimento(id_pavimento);
ALTER TABLE Modelo_Micro ADD CONSTRAINT FK_modelo_marca FOREIGN KEY(id_marca_micro)REFERENCES Marca_Micro(id_marca_micro);
ALTER TABLE Modelo_Monitor ADD CONSTRAINT FK_modelomonitor_marca FOREIGN KEY(id_marca_monitor)REFERENCES Marca_Monitor(id_marca_monitor);